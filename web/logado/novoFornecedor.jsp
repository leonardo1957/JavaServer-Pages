        ...
        <div id="principal" >
            ...
            <div id="sistema" class="espaco_topo div_borda">
                ...
                <form id="form_email" method="post" action="/SitePetshop/crud_fornecedor?cmd=salvar" >
                    ...
                    <div class="div_flex">
                        <label>Nome:</label>
                        <input type="text" name="nome" required value="${fornecedor.nome}" />                        
                    </div>
                    <div class="div_flex">
                        <label>E-mail:</label>
                        <input type="text" name="email" required value="${fornecedor.email}" />                        
                    </div>
                    <div class="div_flex">
                        <label>telefone:</label>
                        <input type="text" name="telefone" required value="${fornecedor.telefone}" />                        
                    </div>
                    <div class="div_flex">
                        <label>Descrição:</label>
                        <textarea id="email_textarea" name="descricao">${fornecedor.descricao}</textarea>
                    </div>
                    <div class="div_flex">
